...
<body>
    ...
    ?>
    <div class="dashboard-panel parallax-section" style="background:url('img/<?php echo $header_one["file_name"]; ?>'); background-size: cover; background-repeat: no-repeat; min-height: 700px; height: 1200px;">
        <div class="dashboard-ab">
            ...
            ?>
                    <a target="_blank" href="<?php echo $banner["link"]; ?>" style="position: relative;"><span class="ads-title"><?php echo $banner["bannerText"]; ?></span><img class="ads_img1" style="width: 900px; height: 120px;border: 1px solid #cbcbcb;border-radius: 10px 10px 10px 10px;" src="img/<?php echo $banner["fileName"]; ?>" alt="ads"></a>
            <?php
                }
            ?>
    ...
    <div align="center">
            ...
            <?php
                if($banners_footer->num_rows > 0) {
                    ...
                    $banner = $arr[$showNumber];
            ?>
                    <a target="_blank" href="<?php echo $banner["link"]; ?>" style="position: relative; "><span class="ads-title ads-title3"><?php echo $banner["bannerText"]; ?></span><img class="ads_img2" style="width: 900px; height: 120px;background-color: #f1edd4;border: 1px solid #cbcbcb;border-radius: 10px 10px 10px 10px;margin-bottom: 10px;" src="img/<?php echo $banner["fileName"]; ?>" alt="ads"></a>
            <?php
                }
            ?>
