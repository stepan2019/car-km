...
$lng['general']['Plate_Number'] = 'Plate Number';
$lng['general']['Vin'] = 'Vin';
$lng['general']['Make'] = 'Make';
$lng['general']['Model'] = 'Model';
$lng['general']['Build_Year'] = 'Build Year';
$lng['general']['KM'] = 'KM';
$lng['general']['date'] = 'Date';
$lng['general']['print_page'] = 'Print';
$lng['general']['Crashed ?'] = 'Crashed ?';
$lng['general']['Status'] = 'Status';
$lng['general']['Yes'] = 'Yes';
$lng['general']['No'] = 'No';
$lng['general']['Front'] = 'Front';
$lng['general']['Back'] = 'Back';
$lng['general']['Left'] = 'Left';
$lng['general']['Right'] = 'Right';
$lng['general']['Total_Loss'] = 'Total Loss';
...
$lng['users']['Fullname'] = 'Fullname';
$lng['users']['password'] = 'Password';
$lng['users']['Address'] = 'Address';
$lng['users']['Email'] = 'E-mail';
$lng['users']['Phone_number'] = 'Phone Number';
...
$lng['useraccount']['Fullname'] = 'Fullname';
$lng['useraccount']['Address'] = 'Address';
$lng['useraccount']['Phone_Number'] = 'Phone Number';
$lng['useraccount']['email'] = 'Email';
$lng['useraccount']['Current_Password'] = 'Current Password';
...
// -------------------------- PASSWORD RECOVERY -------------------
$lng['password_recovery']['email'] = 'Please Input your Email';
$lng['password_recovery']['new_password'] = 'New Password';
$lng['password_recovery']['Reset_password'] = 'Reset Password';
...
$lng['Payment']['Thank_you'] = 'Thanks for Registration of your Vehicle.If you want to see all Report of this vehicle, please click on Generate Report.';
...
// -------------------------- PDF-------------------
$lng['Pdf']['Download_pdf'] = 'Download as PDF';
$lng['Pdf']['Close'] = 'Close this window';
$lng['Pdf']['Print'] = 'Print';
$lng['Pdf']['Tellerrapport'] = 'Tellerrapport';
