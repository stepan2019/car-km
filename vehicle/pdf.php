        ...
        <div class="row col-md-12 text-left mt-4">
            ...
            <div class="col-md-12">
                <p>
                    ...
                    if ($km_last_info['logic'] == "true") {
                        ?>
                        <span class="mr-4"
                              style="font-size: 40px; color: #000;font-weight: bold;"><?php echo $lng['Pdf']['Logical']; ?></span>
                        <img src="/img/Logical.png" alt="record">
                        <?php
                    } else if ($km_last_info['logic'] == "false") {
                        ?>
                        <span class="mr-4"
                              style="font-size: 40px; color: #000;font-weight: bold;"><?php echo $lng['Pdf']['Not_Logical']; ?></span>
                        <img src="/img/Not-Logical.png" alt="record">
                        <?php
                    } else {
                        ?>
                        <span class="mr-4"
                              style="font-size: 40px; color: #000;font-weight: bold;"><?php echo $lng['Pdf']['No-Judgement']; ?></span>
            ...
            <table class="table table-bordered" style="width: 33%;">
                ...
                while ($km_info = $result->fetch_assoc()) {
                    ...
                    <tr>
                        <td class="text-center"
                            style="border-left:none;border-right:none;"><?php echo $km_info['km']; ?></td>
                        <td class="text-center"
                            style="border-left:none;border-right:none;"><?php echo $km_info['add_date']; ?></td>
                    </tr>
                    <?php
