        ...
        <div class="container privacy mt-5">
            ...
            <div class="row pt-2">
                ...
                <div class="col-md-8 privacy-box">
                    <p>All information will be Stord in database to collect as Mach as possible KM of the Vehicle in Greece.</p>
                    ...
                    <p>We will sometimes sent newsletter mail to own registered user , this way you will be up to date with all information, according use of owe database.</p>
