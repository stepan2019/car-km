    ...
    <div class="container-fluid" style="display: flex;">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse1" style="padding-top: 1em;">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a class="nav-link" href="/admin">Home <span
                                class="sr-only">(current)</span></a></li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">User
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Vehicle<span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="home.php?query=vehiclelist">Vehicle list</a></li>
                        <li><a class="nav-link" href="home.php?query=province">Province</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Payment<span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Language<span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Banners<span
                                class="caret"></span></a>
                    <ul class="dropdown-menu">
            ...
            <ul class="navbar-nav ml-auto text-center">
                <li class="ml-4 mr-4"><a class="tooltips text-white"
                                         href="home.php?query=profile"><span>Profile</span><br><i
                                class="fas fa-user-cog"></i></a></li>
                <li><a class="tooltips text-white" href="logout.php"><span>Log out</span><br><i
