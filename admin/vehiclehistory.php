<form method="post">
    <div class="row col-md-12">
        <div class="col-md-5 text-left">
            <div class="agileits-main">
                ...
                <select name="plate" required="" id="select2_make">
                    ...
                    <?php
                    $getVehicleList1 = $config->getVehicleList();
                    $getVehicleList2 = $config->getVehicleList();
                    while ($getVehicleList_fetch = $getVehicleList1->fetch_assoc()) {
                        ?>
                        <option value="<?php echo $getVehicleList_fetch['plate']; ?>"
                            <?php if(isset($_POST['plate'])){if ($getVehicleList_fetch['plate'] == $_POST['plate']) echo "selected";} ?>>
                    ...
                    ?>
                    <?php
                    while ($getVehicleList_fetch = $getVehicleList2->fetch_assoc()) {
                        ?>
        ...
        <div class="col-md-7">
            <button type="submit" class="btn btn-primary submit-fs ml-5 btn-custom" name="view_history" id="view_btn">
                View
            </button>

            <button type="button" class="btn btn-primary submit-fs ml-5 btn-custom" name="" id="generate_report_btn">
                Generate Report
            </button>
            ...
            <div id="html-2-pdfwrapper" class="row col-md-12 text-left mt-4">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $vehicle_info['make']; ?>
                            + <?php echo $vehicle_info['model']; ?></td>
                ...
                <div class="col-md-12">
                    ...
                    <p>Registration of the car KM in Greece is From 2019, we cannot JUDGEMENT about the Km before this
                        year.<br>
