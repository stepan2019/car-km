<?php
    ...
    if (isset($_POST["update"])) {
        ...
        if ($uploadFileName == "") {
            $isSuccess = $config->updateHomescreen($id, $file_name, $title, $position, $imgWidth, $imgHeight, $langId);
            if ($isSuccess) {
            ...
            if (in_array($fileType, $allowTypes)) {
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
                    $isSuccess = $config->updateHomescreen($id, $uploadFileName, $title, $position, $width, $height,$langId);
                    if ($isSuccess) {
    ...
    <div class="col-md-12 row">
        ...
        <div class="col-md-12 mt-4 row">
            <div class="col-md-7 pl-5">
                ...
                <img width="500px" height="300px" src="../img/<?php echo $homescreen["file_name"] ?>"
                     alt="current image">
                    ...
                    <div class="col-md-12">
                        <div class="agileits-main">
                            <select name="position" required="" class="banner-txt">
                                <option <?php if ($homescreen['position'] == "header") echo "selected"; ?>
                                        value="header">Header
                                </option>
                                <option <?php if ($homescreen['position'] == "footer") echo "selected"; ?>
                                        value="footer">Footer
                                </option>
                            </select>
                        </div>
